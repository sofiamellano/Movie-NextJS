...
export const fetchNowPlayingMovies = async () => { await fetch('https://api.themoviedb.org/3/movie/now_playing?language=es-MX&page=1', options); const data = await response.json(); return data.results; };
